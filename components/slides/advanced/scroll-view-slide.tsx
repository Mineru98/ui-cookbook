...
export default function ScrollViewSlide() {
  ...
  return (
    <SlideLayout title="Scroll View (스크롤 뷰)">
      ...
      `}</style>
      <div className="space-y-8 h-full max-h-[calc(100vh-12rem)] overflow-y-auto">
        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  '스크롤 위치: ' + scrollPosition.round().toString(),
                  style: TextStyle(fontSize: 12),
                ),
                SizedBox(width: 8),
                Text(
                  '최대: ' + maxScroll.round().toString(),
                  style: TextStyle(fontSize: 12),
                ),
                SizedBox(width: 8),
                Text(
          ...
          Column(
            children: [
              ...
              LinearProgressIndicator(
                value: maxScroll > 0 ? scrollPosition / maxScroll : 0,
